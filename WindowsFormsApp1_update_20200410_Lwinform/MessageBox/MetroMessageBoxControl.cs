...
using Lwinform.Forms;
using Lwinform.Localization;
...
namespace Lwinform
{
    public partial class MetroMessageBoxControl : Form
    {
        ...
        private void button_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            //button.BackColor = MetroPaint.BackColor.Button.Press(Lwinform.MetroThemeStyle.Light);
            //button.FlatAppearance.BorderColor = MetroPaint.BorderColor.Button.Press(Lwinform.MetroThemeStyle.Light);
            //button.ForeColor = MetroPaint.ForeColor.Button.Press(Lwinform.MetroThemeStyle.Light);
        }
        ...
        private void StylizeButton(MetroButton button, bool hovered)
        {
            ...
            //if (hovered)
            //{
            //    button.FlatAppearance.BorderColor = MetroPaint.BorderColor.Button.Hover(Lwinform.MetroThemeStyle.Light);
            //    button.ForeColor = MetroPaint.ForeColor.Button.Hover(Lwinform.MetroThemeStyle.Light);
            //}
            //else
            //{
            //    button.BackColor = MetroPaint.BackColor.Button.Normal(Lwinform.MetroThemeStyle.Light);
            //    button.FlatAppearance.BorderColor = Color.SlateGray;
            //    button.FlatAppearance.MouseOverBackColor = MetroPaint.BorderColor.Button.Hover(Lwinform.MetroThemeStyle.Light);
            //    button.ForeColor = MetroPaint.ForeColor.Button.Normal(Lwinform.MetroThemeStyle.Light);
